<%@ Page Title="CourseInsert" Language="C#" MasterPageFile="~/MasterPage.Master" CodeBehind="Insert.aspx.cs" Inherits="Comp2007_MidtermExam.Courses.Insert" %>
<asp:Content runat="server" ContentPlaceHolderID="cpMainContent">
    <div>
		<p>&nbsp;</p>
        <asp:FormView runat="server"
            ItemType="Comp2007_MidtermExam.Models.Course" DefaultMode="Insert"
