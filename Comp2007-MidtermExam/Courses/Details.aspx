<%@ Page Title="Course Details" Language="C#" MasterPageFile="~/MasterPage.Master" CodeBehind="Details.aspx.cs" Inherits="Comp2007_MidtermExam.Courses.Details" %>
<asp:Content runat="server" ContentPlaceHolderID="cpMainContent">
    <div>
		<p>&nbsp;</p>
      
        <asp:FormView runat="server"
            ItemType="Comp2007_MidtermExam.Models.Course" DataKeyNames="Id"
