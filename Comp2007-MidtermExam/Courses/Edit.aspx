<%@ Page Title="CourseEdit" Language="C#" MasterPageFile="~/MasterPage.Master" CodeBehind="Edit.aspx.cs" Inherits="Comp2007_MidtermExam.Courses.Edit" %>
<asp:Content runat="server" ContentPlaceHolderID="cpMainContent">
    <div>
		<p>&nbsp;</p>
        <asp:FormView runat="server"
            ItemType="Comp2007_MidtermExam.Models.Course" DefaultMode="Edit" DataKeyNames="Id"
